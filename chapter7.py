...
while True:
    ...
    #cv2.getTrackbarPos("Name of Trackbar","Name of window")
    ...
    #imgResult = cv2.bitwise_and(old image, new image, mask=mask name to be apply)
    # bitwise_and is used to add colour for the mask
